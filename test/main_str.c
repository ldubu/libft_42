...
int main(void)
{
	...
	printf("Test strlen\nOn veut %lu: %lu\n%lu:%lu\n%lu:%lu\n", strlen(dst1), ft_strlen(s1), strlen(s2), ft_strlen(s2), strlen(s3), ft_strlen(s3));
	printf("end of strlen");
	strlcpy(dst1, s1, 5);
	/*printf("\nTest strlcopy retour offi %lu: %lu, dst offi %s : %s\n", strlcpy(dst1, s1, 32), ft_strlcpy(dst1b, s1, 32), dst1, dst1b);
	...
	printf("retour offi %lu: %lu, dst offi %s: %s\n", strlcat(dst2, s2, 4), ft_strlcat(dst2b, s2, 4), dst2, dst2b);
	printf("retour offi %lu: %lu, dst offi %s: %s\n", strlcat(dst1, s1, 10), ft_strlcat(dst1b, s1, 10), dst3, dst3b);
